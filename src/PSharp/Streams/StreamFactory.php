...
/**
 * Represents a stream factory. Implements PSR-7 StreamFactoryInterface.
 *
 */
class StreamFactory implements StreamFactoryInterface
{
	...
	public function createStreamFromFile(string $filename, string $mode = 'r+b'): StreamInterface
	{
		...
		//
		return (new Stream($handle, filesize($filename)))->setMetadata('filename', $filename);
	}
	 ...
	 *
	 * @param string $content String content with which to populate the stream.
	 * @return \PSharp\Streams\StringStream
	 */
